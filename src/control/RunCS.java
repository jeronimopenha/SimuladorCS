...
public class RunCS {
    ...
    public RunCS(HashMap<Integer, JTextField> textMap, JfrmPrincipal jfrmPrincipal) {
    ...
    public void start() {
        ...
        this.codeInterpreter.execute(this.dataMap, cardList, this.jdlgImpress.getJtxaImpress());
    }
